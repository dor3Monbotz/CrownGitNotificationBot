...
if ENV:
    ...
    GIT_REPO_URL = environ.get('GIT_REPO_URL', "https://github.com/dor3Monbotz/CrownGitNotificationBot.git")
else:
...
print("If you need more help, chatchat @projectcrown in Telegram.")
...
def support(_bot, update):
    ...
    message = update.effective_message
    message.reply_text(
        f"*Getting Support*\n\nTo get support in using the bot, Chat [Crown support](https://t.me/projectcrown).",
        parse_mode="markdown"
    )
...
def source(_bot, update):
    ...
    message = update.effective_message
    message.reply_text(
        f"*Source*:\n[Git Repo](https://github.com/dor3Monbotz/CrownGitNotificationBot.git).",
        parse_mode="markdown"
    )
